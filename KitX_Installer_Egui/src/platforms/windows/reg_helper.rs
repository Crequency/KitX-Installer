...
pub fn update_program_registry(
    ...
    // Update App Paths
    let app_paths_key = current_version_key.open_subkey_with_flags("App Paths", KEY_SET_VALUE)?;
    ...
    let uninstall_key = current_version_key.open_subkey_with_flags("Uninstall", KEY_SET_VALUE)?;
